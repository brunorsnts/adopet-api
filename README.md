...
Este repositório é uma **refatoração** da [versão anterior (v1)](https://github.com/brunorsnts/adopet-api/tree/v1), aplicando boas práticas de desenvolvimento de software estudadas no curso.
